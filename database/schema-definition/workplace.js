...
module.exports.schema = {
  ...
  streetName:         require("./fields/field-string")({ name: "streetName", minLength: 3, required: true }),
  ...
  neighborhood:       require("./fields/field-string")({ name: "neighborhood", required: true }),
  ...
  CNESCode:           require("./fields/field-number")({ name: "CNESCode" }), //  Cadastro Nacional de Estabelecimentos de Saúde
